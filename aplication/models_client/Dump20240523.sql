CREATE DATABASE  IF NOT EXISTS `chc` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chc`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: chc
-- ------------------------------------------------------
...
CREATE TABLE `agenda` (
  ...
  CONSTRAINT `agenda_ibfk_1` FOREIGN KEY (`usuariosId`) REFERENCES `usuarios` (`usuariosId`)
...
CREATE TABLE `agendamento` (
  ...
  KEY `usuariosId` (`usuariosId`),
  CONSTRAINT `agendamento_ibfk_1` FOREIGN KEY (`usuariosId`) REFERENCES `usuarios` (`usuariosId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medico` (
  ...
  `ubsId` int DEFAULT NULL,
  PRIMARY KEY (`medicoId`),
  KEY `ubsId` (`ubsId`),
  KEY `agendamentoId` (`agendamentoId`),
  CONSTRAINT `medico_ibfk_1` FOREIGN KEY (`ubsId`) REFERENCES `ubs` (`ubsId`),
  CONSTRAINT `medico_ibfk_2` FOREIGN KEY (`agendamentoId`) REFERENCES `agendamento` (`agendamentoId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-23  3:21:27
